...
class LoginController extends Controller
{
    ...
    */
    ...
    public function login(Request $request)
    {
        ...
        $user_type = $request->filled('user_type') ? $request->input('user_type') : 'admin';
        
        
        if (Auth::attempt(['email' => $email, 'password'=> $password, 'user_type' => $user_type])) {
            flash("Login successgully.")->success();
            return redirect()->route('home');
        }
        
        flash('Oppes! You have entered invalid credentials')->error();
