...
// Define custom routes for email verification
Route::group(['middleware' => ['auth', 'verified']], function () {
    // This group of routes requires authentication and email verification

    // Define a route for resending email verification link
    Route::get('/email/resend', 'Auth\VerificationController@resend')->name('verification.resend');

    // Define a route for email verification confirmation using a code
