            ...
            <div class="card-body">
                <form class="form-horizontal" action="{{ route('project-categories.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="text" id="name" name="name_ar" placeholder="{{ translate('Category Name Arabic') }}" class="form-control" required>
                    </div>
                    <div class="form-group mb-3">
                        <label for="name">{{translate('Description')}}</label>
                        <textarea type="text" id="des" name="des" placeholder="{{ translate('Category Description') }}" class="form-control" required></textarea>
                    </div>
                     <div class="form-group mb-3">
                        <label for="name">{{translate('Description Arabic')}}</label>
                        <textarea type="text" id="des_ar" name="des_ar" placeholder="{{ translate('Category Description Arabic') }}" class="form-control" required></textarea>
                    </div>
                    <!--<div class="form-group mb-3">
