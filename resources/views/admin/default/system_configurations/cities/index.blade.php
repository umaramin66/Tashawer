...
@section('content')
    ...
    <div class="row">
        <div class="col-lg-7">
            <div class="card">
                <div class="card-header">
                    <h5 class="h6 mb-0">{{ translate('City List') }}</h5>
                </div>
                <div class="card-body">
        ...
        <div class="col-lg-5">
            <div class="card">
                <div class="card-header">
                    <h5 class="h6 mb-0">{{translate('Add New City')}}</h5>
                </div>
                <div class="card-body">
                    <form class="form-horizontal" action="{{ route('cities.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group mb-3 text-right">
                            <button type="submit" class="btn btn-primary">{{translate('Save New City')}}</button>
                        </div>
                    </form>
                </div> <!-- end card-body -->
            </div> <!-- end card-->
