    ...
    <div class="aiz-user-sidenav rounded overflow-hidden">
        ...
        <div class="sidemnenu mb-3 px-3">
            <ul class="aiz-side-nav-list" data-toggle="aiz-side-menu">
                ...
                <li class="aiz-side-nav-item mt-3">
                    ...
                    <ul class="aiz-side-nav-list level-2">
                        <li class="aiz-side-nav-item mt-3 px-2">
                            <a href="{{ route('projects.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['projects.index','projects.edit'])}}">
                                <span class="aiz-side-nav-text">{{ translate('All Projects') }}</span>
                            </a>
                        </li>
                        <li class="aiz-side-nav-item mt-3 px-2">
                            <a href="{{ route('projects.create') }}" class="aiz-side-nav-link {{ areActiveRoutes([ 'projects.create'])}}">
                                <span class="aiz-side-nav-text">{{ translate('Add New Project') }}</span>
                            </a>
                        </li>
                        <!--<li class="aiz-side-nav-item mt-3 px-2">
                ...
                <li class="aiz-side-nav-item mt-3">
                    <a href="{{ route('milestone-requests.all') }}" class="aiz-side-nav-link d-flex align-items-center {{ areActiveRoutes(['milestone-requests.all'])}}">
                        ...
                        <span class="aiz-side-nav-text ml-2">{{ translate('Project Milestone Requests') }}</span>
