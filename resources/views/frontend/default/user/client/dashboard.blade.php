    ...
    <div class="container">
        <div class="d-flex align-items-start">
            ...
            <div class="aiz-user-panel">
				...
				@endif-->
				<div class="">
				    <h2><b>{{translate ('Client Dashboard') }}</b></h2>
					<div class="card p-4" style="border:none;">
						<div class="row gutters-15">
						    <div class="col-md-4">
								<div class="bg-1 rounded-1 p-4 mb-4 d-flex flex-column justify-content-center" style="min-height: 110px;;">
									<div class="text-white">{{ translate('Total Projects') }}</div>
									<div class="h4 fw-700 text-white">{{ count(Auth::user()->number_of_projects) }}</div>
								</div>
							</div>
							<div class="col-md-4">
								<div class="bg-2 rounded-1 p-4 mb-4 d-flex flex-column justify-content-center" style="min-height: 110px;">
									<div class="text-white">{{ translate('Completed Project') }}</div>
											@php
												$completedProjects = 0;
									...
									<div class="h4 fw-700 text-white">{{ $completedProjects }}</div>
								</div>
							</div>
							<div class="col-md-4">
								<div class="bg-3 rounded-1 p-4 mb-4 d-flex flex-column justify-content-center" style="min-height: 110px;">
									<div class="text-white">
									{{ translate('Running Project') }}</div>
											@php
												$onGoingProjects = 0;
												foreach (Auth::user()->number_of_projects as $key => $project) {
									...
									<div class="h4 fw-700 text-white">{{ $onGoingProjects }}</div>
								</div>
							</div>
							<div class="col-md-4">
								<div class="bg-4 rounded-1 p-4 mb-4 d-flex flex-column justify-content-center" style="min-height: 116px;">
            		...
            		<!--<div class="col-md-4 d-flex">
            			<div class="card w-100 rounded-2 bg-hov-soft-primary border-1 border-gray-light">
            				<div class="card-body mt-3">
            					<a href="http://localhost/workdesk/projects/create" class="btn btn-primary btn-block rounded-1 py-3 mb-3">
