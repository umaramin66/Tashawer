                                ...
                                <div class="card-footer">
                                	...
                                	@elseif ($project->closed == 1)
	                                    ...
	                                    @if (\App\Models\Review::where('project_id', $project->id)->where('reviewer_user_id', Auth::user()->id)->first() == null)
	                                        <button type="button" onclick="showRatingModal({{ $project->id }})" class="btn btn-secondary btn-sm fw-500">{{ translate('Rate This Consultant') }}</button>
	                                    @else
            ...
            <div class="modal-content">
                <form action="{{ route('reviews.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="modal-footer">
        				...
        				<button type="submit" class="btn btn-primary">{{ translate('Rate This Consultant') }}</button>
        			</div>
                </form>
            </div>
        </div>
