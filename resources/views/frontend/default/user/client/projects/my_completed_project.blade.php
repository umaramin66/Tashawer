							...
							<div class="card project-card border-gray-light">
								...
								<div class="card-footer">
                                    ...
                                    @if (\App\Models\Review::where('project_id', $project->id)->where('reviewer_user_id', Auth::user()->id)->first() == null)
                                        <button type="button" onclick="showRatingModal({{ $project->id }})" class="btn btn-secondary btn-sm fw-500 rounded-1">{{ translate('Rate This Consultant') }}</button>
                                    @else
            ...
            <div class="modal-content">
                <form action="{{ route('reviews.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="modal-header">
                        <h4 class="h6 mb-0">{{translate('Rate This Consultant')}}</h4>
                    ...
                    <div class="modal-footer">
        				...
        				<button type="submit" class="btn btn-primary rounded-1">{{ translate('Rate This Consultant') }}</button>
        			</div>
                </form>
            </div>
        </div>
