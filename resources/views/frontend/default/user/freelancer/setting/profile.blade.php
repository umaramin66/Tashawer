                                ...
                                <div class="form-group row">
                                    <div class="col-lg-4">
                                        ...
                                        <select class="form-control aiz-selectpicker" id="country_id" name="country_id"
                                            ...
                                            @foreach (\App\Models\Country::where('structure', 2)->get() as $key => $country)
                                            ...
                                            <div class="col-xxl-3 col-lg-4 col-sm-6">
                                                ...
                                                <div
                                                    ...
                                                    @if (in_array($ext, $extensions))
                                                        <img class="img-fit mw-100 pt-5 mt-5"
                                                    ...
                                                    <div class="absolute-top-right pt-2 pr-3 lang-change">
                                        ...
                                        @foreach ($user_profile->user->workExperiences as $key => $work_experience)
                                            <div class="col-md-6">
                                                <div class="card rounded-1 border-gray-light">
                                                    <div class="card-body">
                                                        <div class="absolute-top-right pr-3 pt-3 lang-change">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control aiz-selectpicker" id="school_country_id"
                                        name="country_id" required data-live-search="true">
                                          @foreach (\App\Models\Country::where('structure', 2)->get() as $country)
                                            <option value="{{ $country->id }}">{{ $country->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
...
@section('script')
    <script type="text/javascript">
        ...
        let lang = "{{ Session::has('locale') ? Session::get('locale') : 'en'}}";
        ...
        if (lang != 'en') {
            $('.lang-change').removeClass('absolute-top-right');
            $('.lang-change').addClass('absolute-top-left');
        }
    </script>
@endsection
