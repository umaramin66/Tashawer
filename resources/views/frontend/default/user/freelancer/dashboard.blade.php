    ...
    <div class="container">
        <div class="d-flex align-items-start">
            ...
            <div class="aiz-user-panel">
				...
				@endif-->
				 <h2><b>{{ translate ('Consultant Dashboard') }}</b></h2>
            	<div class="row gutters-15 mt-5">
					<div class="col-md-4">
            			<div class="bg-1 text-white mb-4 overflow-hidden rounded-1 d-flex flex-column justify-content-between" style=" min-height:110px;">
            				<div class="px-4 pt-4">
								<div class="row">
									<div class="col-7">
										<div class="fs-14">{{ translate('Balance') }}</div>
										<div class="h5 fw-700">{{ single_price(Auth::user()->profile->balance) }}</div>
										<!--<div class="">
								           <a href="{{ route('logout') }}" class="btn btn-1 btn-light rounded-1 fs-12 fw-500">{{ translate('Logout') }}</a>
							            </div>-->
									</div>
									<div class="col-5">
										<div class="py-2">
										<!--<svg xmlns="http://www.w3.org/2000/svg" width="100" height="64" viewBox="0 0 109.746 106.086">
            		...
            		<div class="col-md-4 d-flex flex-column justify-content-between">
						<div class="bg-2 mb-4 overflow-hidden rounded-1 text-white " style=" min-height:110px;">
							<div class="px-4 pt-4">
								<div class="row">
									<div class="col-7">
										<div class="fs-14 text-white">{{ translate('Completed Projects') }}</div>
										@php
											$completedProjects = 0;
					...
					<div class="col-md-4 d-flex flex-column justify-content-between">
						...
						<div class="bg-3 text-white mb-4 overflow-hidden rounded-1" style=" min-height:110px;">
							<div class="px-4 pt-4">
								<div class="row">
									<div class="col-7">
				...
				<div class="">
					<div class="">
						<div class="row gutters-15">
							<div class="col-md-4">
								<div class="bg-4 rounded-1 p-4 mb-4 d-flex flex-column justify-content-center" style="min-height: 110px;">
							...
							<div class="col-md-4">
								<div class="rounded-1 p-4 bg-dark d-flex flex-column justify-content-center" style="min-height: 110px;">
