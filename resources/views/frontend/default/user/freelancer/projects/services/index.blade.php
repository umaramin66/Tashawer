            ...
            <div class="aiz-user-panel">
                ...
                <div class="row gutters-10">
                    @foreach($services as $service)
                        <div class="col-lg-4">
                            <div class="card overflow-hidden  border-gray-light hov-box">
                                ...
                                <div class="card-body">
                                   ...
                                   <a href="{{ route('service.show', $service->slug) }}" class="text-dark"  title="{{ $service->title }}"><h3 class="card-title fs-16 fw-500 h-40px">{{ \Illuminate\Support\Str::limit($service->title, 40, $end='...') }}</h3></a>
                                </div>
                                <div class="card-footer justify-content-between" style=" border: none;">
