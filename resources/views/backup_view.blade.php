                                        ...
                                        <div class="media-body">
                                            <div class="mb-3 mb-sm-0">
                                                <div class="mb-2">
                                                    ...
                                                    <small class="d-block text-muted">{{ Carbon\Carbon::parse($support_reply->created_at)->format('Y-m-d') }}</small>
                                                </div>
                                            </div>
                                    ...
                                    <div class="media-body">
                                        <div class="mb-3 mb-sm-0">
                                            <div class="mb-2">
                                                ...
                                                <small class="d-block text-muted">{{ Carbon\Carbon::parse($support_ticket->created_at)->format('Y-m-d') }}</small>
                                            </div>
                                        </div>
